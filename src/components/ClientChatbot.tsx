        ...
        {isOpen && (
          <div className="fixed bottom-24 right-6 left-6 sm:left-auto z-50 font-sans">
            <motion.div
              ...
              className="w-full sm:w-96 h-[400px] max-h-[60vh] sm:h-[500px] sm:max-h-none rounded-[20px] bg-zinc-950/95 backdrop-blur-xl border border-white/10 shadow-[0_0_50px_rgba(59,130,246,0.15)] flex flex-col justify-between p-4 sm:p-6 mb-4 origin-bottom-right overflow-hidden relative"
            >
