...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {/* Mobile Nav Drawer (Isolated outside parent nav container for absolute stability on scroll) */}
      {isOpen && (
        <div
          className="fixed inset-y-0 right-0 w-full max-w-xs bg-black/95 backdrop-blur-2xl border-l border-white/10 z-[9999] p-8 md:hidden overflow-y-auto"
        >
